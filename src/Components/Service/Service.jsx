...
const Service = () => {
  return (
    <div className="bg-red-500 py-10 px-4 md:px-10">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        {services.map((service) => (
          <div key={service.id} className="bg-base-300 shadow-md rounded-lg p-6 flex flex-col items-center text-center hover:shadow-xl transition">
            {service.icon}
